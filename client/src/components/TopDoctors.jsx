  ...
  return (
    <div className="flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10">
      ...
      <p className="sm:w-1/3 text-center text-sm">
        Discover highly rated doctors and book your appointment with confidence.
      </p>
      ...
      <button onClick={()=>{ navigate('/doctors'); scrollTo(0,0)}} className="bg-blue-50 text-gray-600 px-12 py-3 rounded-full my-10">
        more
      </button>
    </div>
  );
